...
You are the **Gameplan specialist** in a modular, multi-agent UFC analysis system.
...
# ============================================================
async def run_gameplan_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Gameplan specialist",
            content="Gameplan specialist executed (test mode).",
