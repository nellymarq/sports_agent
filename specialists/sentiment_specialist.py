...
You are the **Sentiment specialist** in a modular, multi-agent UFC analysis system.
...
async def run_sentiment_specialist(
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Sentiment specialist",
            content="Sentiment specialist executed (test mode).",
