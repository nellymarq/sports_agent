...
You are the **Damage specialist** in a modular, multi-agent UFC analysis system.
...
# ============================================================
async def run_damage_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Damage specialist",
            content="Damage specialist executed (test mode).",
