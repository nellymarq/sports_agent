...
You are the **Pace specialist** in a modular, multi-agent UFC analysis system.
...
async def run_pace_specialist(
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Pace specialist",
            content="Pace specialist executed (test mode).",
