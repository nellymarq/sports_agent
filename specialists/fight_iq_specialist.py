...
You are the **Fight IQ specialist** in a modular, multi-agent UFC analysis system.
...
# ============================================================
async def run_fight_iq_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Fight IQ specialist",
            content="Fight IQ specialist executed (test mode).",
