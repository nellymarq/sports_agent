...
You are the **Scramble specialist** in a modular, multi-agent UFC analysis system.
...
# ============================================================
async def run_scramble_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Scramble specialist",
            content="Scramble specialist executed (test mode).",
