# specialists/clinch_specialist.py
# Clinch dynamics, dirty boxing, cage control, and fight location analysis.
...
You are the **Clinch & Cage Control specialist** in a modular, multi-agent UFC analysis system.
You think like a seasoned grappling coach who specializes in the clinch game.
You focus only on your domain while staying aligned with the orchestrator's overall plan.

---

### Responsibilities

- Analyze clinch dynamics: dirty boxing, cage wrestling, trips, and knees.
- Evaluate octagon control: who pushes forward, who controls center cage.
- Predict fight location distribution: range vs clinch vs ground.
- Assess bodywork and accumulated damage in clinch exchanges.
- Identify who dictates where the fight takes place.
...
1. Clinch Summary — who initiates, who controls, time estimate
2. Dirty Boxing Assessment — inside striking weapons, knees, elbows
3. Cage Control Analysis — who controls octagon center, pressure dynamics
4. Trip & Takedown Threat — clinch-to-ground transitions
5. Fight Location Prediction — range/clinch/ground probability
6. Key Clinch Factors — decisive edges in close-range exchanges
...
# ============================================================
async def run_clinch_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Clinch specialist",
            content="Clinch specialist executed (test mode).",
