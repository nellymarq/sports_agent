...
You are the **Grappling specialist** in a modular, multi-agent UFC analysis system.
...
# ============================================================
async def run_grappling_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Grappling specialist",
            content="Grappling specialist executed (test mode).",
