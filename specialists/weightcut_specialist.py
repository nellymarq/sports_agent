...
You are the **Weightcut specialist** in a modular, multi-agent UFC analysis system.
...
# ============================================================
async def run_weightcut_specialist(
    llm=None,
    tool_registry=None,
    user_input=None,
    history=None,
    ...
    if not tool_registry:
        return SpecialistOutput.create(
            specialist="Weightcut specialist",
            content="Weightcut specialist executed (test mode).",
